...
namespace Axiom.GeoMath
{
	...
	public static class MathUtils
	{
		...
		public static bool IsEqualsOrGreater(double n1, double n2) => IsEqualsOrGreater(n1, n2, MathUtils.FineTolerance);
		...
		public static bool IsEqualsOrLesser(double n1, double n2) => IsEqualsOrLesser(n1, n2, FineTolerance);
		...
		public static double AngleToRange02PI(double radAngle)
		{
		...
		public static double AngleToRange0360(double degAngle)
		{
		...
		public static double InternalAngle(double degAngle1, double degAngle2)
		{
